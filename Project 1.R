...
#Ýsteðe baðlý olarak ayrý iþlemlere ve deðiþkenlere de tabi tutulabilir.
'
mass<-starwars %>%
  group_by(species) %>%
...
#Bu þekilde de hepsi ayrý bir atrribute içine atanýpta species sayýmý yaptýrabiliriz.Sadece bu biraz daha kod kalabalýklýðýna ve ekstra yer tutumuna neden oluyor.
